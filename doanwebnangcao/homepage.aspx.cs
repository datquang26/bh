...
namespace doanwebnangcao
{
    public partial class homepage1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            List<BannerHome> lstBH = dao.DaoBannerHome.getAllBannerHome1();
            gvBH.DataSource = lstBH;
            gvBH.DataBind();

            List<BannerHome> lstBH2 = dao.DaoBannerHome.getAllBannerHome2();
            ...
            if (!Page.IsPostBack)
            {
                ...
                List<SanPham> lstSP = dao.DaoSanPham.getAllSanPhamPopAll();
        ...
        protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            List<BannerHome> lstBH = dao.DaoBannerHome.getAllBannerHomeByMaLoaiSP(Convert.ToInt32(DropDownList1.SelectedValue));
            gvBH.DataSource = lstBH;
            gvBH.DataBind();
        }
    }

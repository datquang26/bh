                        ...
                        <div class="grid">
                            <div class="box-manage-banner-all">
                                ...
                                <div class="box-gridview-banner-all">
                                    <asp:GridView  ID="gvND"  PageSize="3"  AutoGenerateColumns="false" runat="server" Width="100%" CellPadding="4" 
                   EnableViewState="false" DataKeyNames="ID" ForeColor="#000000" BackColor="#f5f5f5" BorderColor="gray" GridLines="Both"  AllowPaging="true"  OnPageIndexChanging="gvND_PageIndexChanging"  OnRowDeleting="gvND_RowDeleting"  OnRowEditing="gvND_RowEditing"  > 
             <Columns>

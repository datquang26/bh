...
.img-product-adv{
       ...
       <div class="content-pane active">
            ...
            <div class="content-home-page">
                  <asp:GridView  ID="gvSL"   AutoGenerateColumns="false" runat="server" 
                   EnableViewState="false" DataKeyNames="MaSliderAnh"  RepeatDirection="Horizontal"  > 
             <Columns>
                 ...
                 <asp:TemplateField >
                    <ItemTemplate>
                         ...
                         <div class="slider-auto" style="width:1347px ; height: 471px; ">
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        <ol class="carousel-indicators">
                          <li data-target="#carouselExampleIndicators" data-slide-to="0" class="active" style="width: 10px ; height: 10px; border: 3px solid red; border-radius: 10px; "></li>
                          <li data-target="#carouselExampleIndicators" data-slide-to="1" style="width: 10px ; height: 10px; border: 3px solid red; border-radius: 10px; " ></li>
                          <li data-target="#carouselExampleIndicators" data-slide-to="2" style="width: 10px ; height: 10px; border: 3px solid red; border-radius: 10px; " ></li>
                          <li data-target="#carouselExampleIndicators" data-slide-to="3" style="width: 10px ; height: 10px; border: 3px solid red; border-radius: 10px; " ></li>
                        </ol>
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                              
                              <asp:Image ID="Image1" runat="server" ImageUrl='<%#"~/img/"+Eval("Anh1") %>' class="d-block w-100" style="height: 471px;" alt="..." />
                          
                            <!--  <img src="../img/slide-1.jpg" class="d-block w-100" alt="...">   -->
                          </div>
                          <div class="carousel-item">
                              <asp:Image ID="Image2" runat="server" ImageUrl='<%#"~/img/"+Eval("Anh2") %>' class="d-block w-100" style="height: 471px;" alt="..." />

                             <!-- <img src="../img/slide-2.jpg" class="d-block w-100" alt="..."> -->
                          </div>
                          <div class="carousel-item">
                              <asp:Image ID="Image3" runat="server" ImageUrl='<%#"~/img/"+Eval("Anh3") %>' class="d-block w-100" style="height: 471px;" alt="..." />

                          <!--  <img src="../img/slide-3.jpg" class="d-block w-100" alt="..."> -->
                          </div>
                          <div class="carousel-item">
                              <asp:Image ID="Image4" runat="server" ImageUrl='<%#"~/img/"+Eval("Anh4") %>' class="d-block w-100" style="height: 471px;" alt="..." />
                ...
                <div class="product-adv">
                   <div class="grid">
                       ...
                       <asp:DropDownList ID="DropDownList1" style=" outline: none;border: none; width: 240px;" class="title-product-adv" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                     ...
                     <div class="product-content-adv">
                                 ...
                                 <asp:TemplateField>
                                     <ItemTemplate>
                                         ...
                                         <div class="box-product-img-adv" style="height: 693px;">
                                             <asp:Image ID="Image5" runat="server" class="img-product-adv" ImageUrl='<%#"~/img/"+Eval("Anh1") %>' style="height: 100%;" />
                        ...
                        <div class="box-product-img-adv">
                            <img src="../img/product-adv-1.jpg" alt="" class="img-product-adv">
                        </div>
                         -->
             ...
             <Columns>
                 ...
                 <!--   <div class="title-product-adv">Pop Up Parade</div> -->
                ...
                <div class="product-adv">
                    ...
                    <div class="grid">
                     <div class="title-product-adv">New Product</div>

                     <div class="product-content-adv">

                          <div class="box-product-adv">
                               <asp:GridView  ID="gvSP2"   AutoGenerateColumns="false" runat="server" 
                   EnableViewState="false" DataKeyNames="MaSanPham"  RepeatDirection="Horizontal"  > 
             <Columns>
                 ...
                 <asp:TemplateField >
                    <ItemTemplate>
                        ...
                        <div style="width: 192px ; height: 351px; padding: 4px 7px; ">
                         ...
                         <asp:GridView ID="gvBH2" AutoGenerateColumns="false" runat="server"
                             EnableViewState="false" DataKeyNames="MaBannerHome" RepeatDirection="Horizontal">
                             <Columns>
                                 ...
                                 <asp:TemplateField>
                                     <ItemTemplate>
                                         ...
                                         <div class="box-product-img-adv" style="height: 693px;">
                                             <asp:Image ID="Image10" runat="server" class="img-product-adv" ImageUrl='<%#"~/img/"+Eval("Anh1") %>' style="height: 100%;" />
         ...
         <%--    <asp:GridView  ID="gvBA"   AutoGenerateColumns="false" runat="server" 
             ...
             <Columns>
                 ...
                 <asp:TemplateField >
                    ...
                    <div class="box-banner-home-page" style="margin: 0px; width: 1347px;">
  ...
  <asp:GridView  ID="gvBA"   AutoGenerateColumns="false" runat="server" 
             ...
             <Columns>
                 ...
                 <asp:TemplateField >
                    ...
                    <div class="box-banner-home-page" style="margin: 0px; width: 1347px; justify-content: flex-start;">
                        <asp:Image ID="Image8" runat="server" class="img-banner-homepage" ImageUrl='<%#"~/img/"+Eval("AnhBanner") %>' style="width: 100%; position: relative; " />
                         <div class="box-title-banner-parade" style="position: absolute; ">
                        <span class="title-parade" style=" text-shadow: 5px 5px 2px #0c5373;"><%#Eval("TenBanner") %></span>
                        <span class="text-banner-parade" style=" text-shadow: 2px 2px 0px #0c5373;"><%#Eval("MoTaBanner") %></span>
                    </div>
                </div>
                ...
                <!--
                <div class="box-banner-home-page">
                    <img src="../img/img-banner-home-page.jpg" alt="" class="img-banner-homepage">
                </div>
                -->
        ...
        <div class="box-img-sale" style=" position: fixed; top: 100px ; left: 350px">
            <a href="https://www.facebook.com/taquangdat2605">
        <img src="../img/img-sale2.jpg" alt="Alternate Text" class="img-sale-adv"  />
            </a>
        </div>

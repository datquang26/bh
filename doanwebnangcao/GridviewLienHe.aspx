                        ...
                        <div class="grid">
                            <div class="box-manage-banner-all">
                                ...
                                <div class="box-gridview-banner-all">
                                    <asp:GridView  ID="gvLH" PageSize="3"   AutoGenerateColumns="false" runat="server" Width="100%" CellPadding="4" 
                   EnableViewState="false" DataKeyNames="MaLienHe" ForeColor="#000000" BackColor="#f5f5f5" BorderColor="gray" GridLines="Both"   AllowPaging="true"  OnPageIndexChanging="gvLH_PageIndexChanging" OnRowDeleting="gvLH_RowDeleting"      > 
             <Columns>

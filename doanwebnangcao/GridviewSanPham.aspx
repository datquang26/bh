                        ...
                        <div class="grid">
                            <div class="box-manage-banner-all ">
                                ...
                                <div class="box-gridview-banner-all long">
                                    <asp:GridView  ID="gvSP"   PageSize="3"  AutoGenerateColumns="false" runat="server" Width="100%" CellPadding="4" 
                   EnableViewState="false" DataKeyNames="MaSanPham" ForeColor="#000000" BackColor="#f5f5f5" BorderColor="gray" GridLines="Both" AllowPaging="true" OnPageIndexChanging="gvSP_PageIndexChanging"  OnRowDeleting="gvSP_RowDeleting"  OnRowEditing="gvSP_RowEditing"   > 
             <Columns>
                  ...
                  <asp:TemplateField HeaderText="PhatHanh" HeaderStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                   <%--<%# Convert.ToDateTime(Eval("PhatHanh")).ToShortDateString() %>--%>
                          <%--<%#Eval("PhatHanh") %>--%>    <%# Convert.ToDateTime(Eval("PhatHanh")).ToString("dd/MM/yyyy") %>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center"   />
                </asp:TemplateField> 
                 ...
                 <asp:TemplateField HeaderText="Anh1" HeaderStyle-HorizontalAlign="Center">
                  ...
                  <asp:TemplateField HeaderText="Anh2" HeaderStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:Image ID="Image2" runat="server" ImageUrl='<%#"~/img/"+Eval("Anh2") %>' style="width: 100px" />

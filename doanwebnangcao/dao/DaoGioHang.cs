...
namespace doanwebnangcao.dao
{
    public class DaoGioHang
    {
        ...
        public static GioHang TongTien(int _iD)
        {
            ...
            string sql = "select  ID, SUM(GiaTien * SoLuong) as TongTien from SanPham, GioHang where GioHang.MaSanPham = SanPham.MaSanPham and ID = '" + _iD + "' group by ID";
            ...
            using (SqlConnection conn = new SqlConnection(strConnection))
            {
                ...
                {
                    objGH = new GioHang();
                    objGH.TongTien = Convert.ToInt32(reader["TongTien"]);
                }

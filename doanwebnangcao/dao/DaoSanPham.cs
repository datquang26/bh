...
namespace doanwebnangcao.dao
{
    public class DaoSanPham
    {
        ...
        public static List<SanPham> getAllSanPhamFigmaAll()
        {
            List<SanPham> lstSP = new List<SanPham>();
            //Lấy thông tin chuỗi kết nối từ Web.config
            string strConnection = ConfigurationManager.ConnectionStrings["ConnDB"].ConnectionString;
            //Viết câu lệnh truy vấn
            string strSQL = "SELECT MaSanPham, TenSanPham, GiaTien, NhanVat, HangSanXuat, KichThuoc, PhatHanh, Anh1, Anh2, Anh3, Anh4, Anh5, Anh6, CategoryId, LoaiSP, Series FROM SanPham where LoaiSP = 'figma' ";
            //Định nghĩa đối tượng Connection
            using (SqlConnection sqlConnection = new SqlConnection(strConnection))
            {
                //Khởi tạo đối tượng Command
        ...
        public static List<SanPham> getAllSanPhamPopAll()
        {
            List<SanPham> lstSP = new List<SanPham>();
            //Lấy thông tin chuỗi kết nối từ Web.config
            string strConnection = ConfigurationManager.ConnectionStrings["ConnDB"].ConnectionString;
            //Viết câu lệnh truy vấn
            string strSQL = "SELECT MaSanPham, TenSanPham, GiaTien, NhanVat, HangSanXuat, KichThuoc, PhatHanh, Anh1, Anh2, Anh3, Anh4, Anh5, Anh6, CategoryId, LoaiSP, Series FROM SanPham where LoaiSP = 'pop'";
            //Định nghĩa đối tượng Connection
            using (SqlConnection sqlConnection = new SqlConnection(strConnection))
            {
                //Khởi tạo đối tượng Command
        ...
        public static List<SanPham> getAllSanPhamByrandom()
        {
            List<SanPham> lstSP = new List<SanPham>();
            //Lấy thông tin chuỗi kết nối từ Web.config
            string strConnection = ConfigurationManager.ConnectionStrings["ConnDB"].ConnectionString;
            //Viết câu lệnh truy vấn
            string strSQL = "SELECT TOP 8 MaSanPham, TenSanPham, GiaTien, NhanVat, HangSanXuat, KichThuoc, PhatHanh, Anh1, Anh2, Anh3, Anh4, Anh5, Anh6, CategoryId, LoaiSP, Series, MaLoaiSP FROM SanPham ORDER BY NEWID() ";
            //Định nghĩa đối tượng Connection
            using (SqlConnection sqlConnection = new SqlConnection(strConnection))
            {
                //Khởi tạo đối tượng Command

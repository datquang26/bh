...
namespace doanwebnangcao
{
    public partial class GridviewLienHe : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                List<LienHe> lstLH = dao.DaoLienHe.getAllLienHe();
                gvLH.DataSource = lstLH;
                gvLH.DataBind();

            }
        }

        protected void gvLH_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            gvLH.PageIndex = e.NewPageIndex;
            List<LienHe> lstLH = dao.DaoLienHe.getAllLienHe();
            gvLH.DataSource = lstLH;
            gvLH.DataBind();
        }

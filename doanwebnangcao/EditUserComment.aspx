<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="EditUserComment.aspx.cs" Inherits="doanwebnangcao.EditUserComment" %>
                    ...
                    <div class="box-manage">
                        <div class="grid">
                            <div class="box-manage-banner-all">
                                <span class="title-banner-all">Sửa User Comment</span>
                                    ...
                                    <div class="box-content-insert">
                                       <asp:Label ID="Label1" runat="server" Text="" style="font-size: 10px; color: red; padding-top: 2px; padding-right: 22px; text-align: right;"></asp:Label>
                                         ...
                                         <div class="box-content-input">
                                            <span class="text-insert-input">Mã Comment:</span>
                                            <div class="box-insert-input">
                                                <asp:TextBox class="input-input-text" ID="tbMaComment" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="box-content-input">
                                            <span class="text-insert-input"> Text comment:</span>
                                            <div class="box-insert-input">
                                                <asp:TextBox class="input-input-text" ID="tbTextComment" runat="server"></asp:TextBox>
                                            </div>
                                        </div>

                                        <div class="box-content-input">
                                            <span class="text-insert-input"> Ma san pham:</span>
                                            <div class="box-insert-input">
                                         ...
                                         <div class="box-content-input">
                                            <span class="text-insert-input"> Anh1:</span>
                                            <div class="box-insert-input">
                                                <asp:FileUpload ID="FileUpload1" runat="server" class="input-input-text" />
                                            </div>
                                        </div>

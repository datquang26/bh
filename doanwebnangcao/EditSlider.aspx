<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="EditSlider.aspx.cs" Inherits="doanwebnangcao.EditSlider" %>
                    ...
                    <div class="box-manage">
                        <div class="grid">
                            <div class="box-manage-banner-all">
                                <span class="title-banner-all">Sửa Slider</span>
                                    ...
                                    <div class="box-content-insert">
                                       <asp:Label ID="Label1" runat="server" Text="" style="font-size: 10px; color: red; padding-top: 2px; padding-right: 22px; text-align: right;"></asp:Label>
                                         ...
                                         <div class="box-content-input">
                                            <span class="text-insert-input">Mã Slider Anh :</span>
                                            <div class="box-insert-input">
                                                <asp:TextBox class="input-input-text" ID="tbMaSliderAnh" runat="server"></asp:TextBox>
                                            </div>
                                        </div>

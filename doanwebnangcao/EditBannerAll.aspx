<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="EditBannerAll.aspx.cs" Inherits="doanwebnangcao.EditBannerAll" %>
                    ...
                    <div class="box-manage">
                        <div class="grid">
                            <div class="box-manage-banner-all">
                                <span class="title-banner-all">Sửa Banner All</span>
                                    ...
                                    <div class="box-content-insert">
                                       <asp:Label ID="Label1" runat="server" Text="" style="font-size: 10px; color: red; padding-top: 2px; padding-right: 22px; text-align: right;"></asp:Label>
                                         ...
                                         <div class="box-content-input">
                                            <span class="text-insert-input">Mã Banner:</span>
                                            <div class="box-insert-input">
                                                <asp:TextBox class="input-input-text" ID="tbMaBanner" runat="server"></asp:TextBox>
                                            </div>
                                        </div>

                                        <div class="box-content-input">
                                            <span class="text-insert-input">Tên Banner:</span>
                                            <div class="box-insert-input">
                                          ...
                                          <div class="box-content-input">
                                            <span class="text-insert-input">Ảnh Banner:</span>
                                            <div class="box-insert-input">

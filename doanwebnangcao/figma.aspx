   ...
   transition: all 0.3s ease;
      ...
      <div class="figma content-pane active ">
            <div class="content-pane-figma">
             ...
             <Columns>
                 ...
                 <asp:TemplateField >
                    <ItemTemplate>
                          <div class="img-banner-figma" style="width: 1347px; height: 362px;background-image: url('<%#"../img/"+Eval("AnhBanner") %>')">
                ...
                <!--
                <div class="img-banner-figma">
                    <div class="box-title-banner-parade">
                        <span class="title-parade">Figma</span>
                        <span class="text-banner-parade">& CÁC LOẠI ACTION FIGURE</span>
                    </div>
               </div>
                -->
               ...
               <div class="grid">
                   ...
                   <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    ...
                    <span class="title-product-parade">Figma</span>
                      <div class="box-input figma" style="width: 567px; margin: 0px; position: relative; top: -513px; left: 67px; z-index: 2000; ">
      ...
      <!-- 
                    ...
                    <div class="grid__column-4">
                        <a href="" class="product-item-adv-link-parade">
                            <div class="box-img-change-parade">
                                 <img src="../img/product-figma-1.jpg" alt="" class="img-product-default-parade">
                                 <img src="../img/product-figma-1-1.jpg" alt="" class="img-product-change-parade">
                            </div>
                            <div class="product-item-content-adv-parade">
                             <div class="product-item-content-title-parade">Atelier Ryza: Ever Darkness & the Secret Hideout Ryza "Atelier" Series 25th Anniversary ver. 1/7 Regular Edition</div>
                             <div class="product-item-content-cost-parade">6,400,000₫</div>
                    ...
                    <div class="grid__column-4">
                        <a href="../product.aspx" class="product-item-adv-link-parade">
                            <div class="box-img-change-parade">
                                 <img src="../img/product-figma-5.jpg" alt="" class="img-product-default-parade">
                                 <img src="../img/product-figma-5-1.jpg" alt="" class="img-product-change-parade">
                            </div>
                            <div class="product-item-content-adv-parade">
                             <div class="product-item-content-title-parade">Atelier Ryza: Ever Darkness & the Secret Hideout Ryza "Atelier" Series 25th Anniversary ver. 1/7 Regular Edition</div>
                             <div class="product-item-content-cost-parade">6,400,000₫</div>
    ...
    <div class="box-adv-node">
        ...
        <div class="content-adv ">
            ...
            <img src="../img/img-adv-node.jpg" alt="Alternate Text" class="img-adv-node " style="height: 100%; width: 100%; " />
            </a>
        </div>
